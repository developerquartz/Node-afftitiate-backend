...
const addValidate = (req, res, next) => {
    ...
    let isValid = validateRequest(req.body, {
        ...
        bankAddress:stringAllowNull,
        accountNumber: stringRequired,
        accountHolderName: stringRequired,
        ifscCode: stringAllowNull,
        currency: stringAllowNull,
        country: stringAllowNull,
        routingNumber:stringRequired,
        accountType:stringAllowNull,
        swiftCode:stringAllowNull,
        taxIdentificationNumber:stringAllowNull,
